...
const ThermalInvoice = ({ isOpen, onClose, saleId, saleData, onReady }) => {
        ...
        <style>
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          @media print {
            ...
            /* Ensure footer flows to next page if needed */
            .footer-section,
            .thank-you-section {
              page-break-before: auto;
              page-break-after: avoid;
  ...
  // Prepare complete sale data for sharing
  const shareSaleData = {
    ...invoiceData,
    businessName: businessInfo?.businessName || businessInfo?.name || 'YOUR STORE NAME',
    gstNumber: businessInfo?.gstNumber || businessInfo?.gst || '',
    address: businessInfo?.address || {},
    currency: businessInfo?.currency || 'INR',
  };

  // Wrap the final output in a React Fragment (<> ... </>) to prevent adjacent JSX errors
  return (
    <>
        ...
        <div className="relative w-full max-w-md max-h-[90vh] flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto bg-white rounded-b-lg">
            ...
            <div id="thermal-bill-content" className="bg-white mx-auto" style={{ width: '320px', fontFamily: 'monospace' }}>
                  ...
                  <div style={{ fontSize: '10px' }}>
                    {typeof businessInfo.address === 'string' ? (
                      ...
                      <>
                        ...
                        {/* Fix: Wrapped the condition in parentheses to ensure correct precedence */}
              ...
              {/* Final Total */}
              <div className="thank-you-section border-t-2 border-black pt-2 mb-3 text-center" style={{ fontSize: '14px' }}>
              ...
              {/* Footer */}
              <div className="footer-section text-center mt-4" style={{ fontSize: '11px' }}>
                <p className="font-bold">Thank You!</p>
                <p>Visit Again!</p>
              </div>

              {/* Print timestamp */}
              <div className="footer-section text-center mt-3 pt-2 border-t border-gray-300" style={{ fontSize: '8px', color: '#666' }}>
